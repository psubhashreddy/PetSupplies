...
public class UserController
{
   ...
   public String updateUser()
   {
      ...
      User userOld = (User) ((HttpSession) FacesContext.getCurrentInstance().getExternalContext().getSession(false)).getAttribute(Constants.LOGGED_IN_USER);
      ...
      {
         FacesMessage facesMsg = new FacesMessage(FacesMessage.SEVERITY_INFO, Constants.NO_UPDATE_FOUND, Constants.NO_UPDATE_FOUND);
         FacesContext.getCurrentInstance().getExternalContext().getFlash().setKeepMessages(true);
         FacesContext.getCurrentInstance().addMessage(null, facesMsg);
      }
