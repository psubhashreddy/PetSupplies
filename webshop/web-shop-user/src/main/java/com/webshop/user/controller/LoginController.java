...
public class LoginController {
	 ...
	 *            the navigationController to set
	 */
	...
	/**
	 * This method is for logging into the application by validating the user
	 * credentials
	 * 
	 * @return String
	 */
	public String login() {
		logger.info("**** In login in User Controller ****");
		...
		if (userObj != null) {
			...
			FacesMessage facesMsg = new FacesMessage(
					FacesMessage.SEVERITY_ERROR, Constants.INVALID_CREDENTIALS,
	...
	public String logout() {
		logger.info("**** In logout in User Controller ****");
