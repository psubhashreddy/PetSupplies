...
/**
 * This class is the controller for performing all the crud operations on the product
 * 
 * @see
 * @author speddyre
 * @date 3rd June 2015
...
public class ProductController
{
   ...
   /**
    * This method is for loading the category list for displaying in the product creation form
    */
   @PostConstruct
   public void init()
   {
   ...
   /**
    * This method is for creating a new product by doing necessary validations. (non-Javadoc)
    * 
   ...
   public String createProduct()
   {
      ...
      if (product != null && StringUtils.isNotEmpty(product.getProductCode()))
      {
         ...
         if (creationMessage.equalsIgnoreCase(Constants.PRODUCT_CREATION_SUCCESS))
         {
            FacesMessage facesMsg = new FacesMessage(FacesMessage.SEVERITY_INFO, Constants.PRODUCT_CREATION_SUCCESS, Constants.PRODUCT_CREATION_SUCCESS);
            FacesContext.getCurrentInstance().getExternalContext().getFlash().setKeepMessages(true);
            FacesContext.getCurrentInstance().addMessage(null, facesMsg);
         }
         else if (creationMessage.equalsIgnoreCase(Constants.PRODUCT_ALREADY_EXISTS))
         {
            FacesMessage facesMsg = new FacesMessage(FacesMessage.SEVERITY_ERROR, Constants.PRODUCT_ALREADY_EXISTS, Constants.PRODUCT_ALREADY_EXISTS);
            FacesContext.getCurrentInstance().getExternalContext().getFlash().setKeepMessages(true);
            FacesContext.getCurrentInstance().addMessage(null, facesMsg);
         }
         else if (creationMessage.equalsIgnoreCase(Constants.PRODUCT_CREATION_EXCEPTION))
         {
            FacesMessage facesMsg = new FacesMessage(FacesMessage.SEVERITY_ERROR, Constants.PRODUCT_CREATION_EXCEPTION, Constants.PRODUCT_CREATION_EXCEPTION);
            FacesContext.getCurrentInstance().getExternalContext().getFlash().setKeepMessages(true);
            FacesContext.getCurrentInstance().addMessage(null, facesMsg);
         }
         else if (creationMessage.equalsIgnoreCase(Constants.FAILURE))
         {
            FacesMessage facesMsg = new FacesMessage(FacesMessage.SEVERITY_ERROR, Constants.PRODUCT_CREATION_FAILURE, Constants.PRODUCT_CREATION_FAILURE);
            FacesContext.getCurrentInstance().getExternalContext().getFlash().setKeepMessages(true);
            FacesContext.getCurrentInstance().addMessage(null, facesMsg);
         }
      }
   ...
   public String deleteProduct()
   {
      ...
      if (deleteFlag)
      {
         FacesMessage facesMsg = new FacesMessage(FacesMessage.SEVERITY_INFO, Constants.PRODUCT_DELETION_SUCCESS, Constants.PRODUCT_DELETION_SUCCESS);
         FacesContext.getCurrentInstance().getExternalContext().getFlash().setKeepMessages(true);
         FacesContext.getCurrentInstance().addMessage(null, facesMsg);
      }
   ...
   /**
    * This method is for opening the edit view for editing the Product (non-Javadoc)
    * 
   ...
   public String updateProduct()
   {
      ...
      if (updateFlag)
      {
         FacesMessage facesMsg = new FacesMessage(FacesMessage.SEVERITY_INFO, Constants.PRODUCT_UPDATION_SUCCESS, Constants.PRODUCT_UPDATION_SUCCESS);
         FacesContext.getCurrentInstance().getExternalContext().getFlash().setKeepMessages(true);
         FacesContext.getCurrentInstance().addMessage(null, facesMsg);
      }
      return searchProduct();
   ...
   /**
    * This method is for listing all the products without any filter (non-Javadoc)
    * 
   ...
   /**
    * This method is for searching a product based on the filter criteria (non-Javadoc)
    * 
   ...
   public String searchProductsByCriteria()
   {
      ...
      if (product != null && (StringUtils.isNotEmpty(product.getProductCode()) || StringUtils.isNotEmpty(product.getProductName())))
      {
