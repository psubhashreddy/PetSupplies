...
/**
 * This class is the controller for doing for doing all the crud operations on the categories
 * 
 * @see
 * @author speddyre
 * @date 3rd June 2015
...
public class CategoryController
{
   ...
   /**
    * This method is for creating a new category by doing necessary validations. (non-Javadoc)
    * 
   ...
   /**
    * This method is for opening the category in delete view for deleting the item (non-Javadoc)
    * 
   ...
   /**
    * This method is for deleting a category that user has selected (non-Javadoc)
    * 
   ...
   /**
    * This method is for searching and listing all the categories with out any criteria (non-Javadoc)
    * 
