...
/**
 * This class is the controller for managing the role for doing all the crud operations.
 * 
 * @author speddyre
 * @date 3rd June 2015
 */
...
public class RoleController
{
   ...
   /**
    * This method is for creating a new role by doing necessary validations. (non-Javadoc)
    * 
   ...
   public String createRole()
   {
      ...
      if (role != null && StringUtils.isNotEmpty(role.getRoleName()))
      {
         ...
         if (creationMessage.equalsIgnoreCase(Constants.ROLE_CREATION_SUCCESS))
         {
            FacesMessage facesMsg = new FacesMessage(FacesMessage.SEVERITY_INFO, Constants.ROLE_CREATION_SUCCESS, Constants.ROLE_CREATION_SUCCESS);
            FacesContext.getCurrentInstance().getExternalContext().getFlash().setKeepMessages(true);
            FacesContext.getCurrentInstance().addMessage(null, facesMsg);
         }
         else if (creationMessage.equalsIgnoreCase(Constants.ROLE_ALREADY_EXISTS))
         {
            FacesMessage facesMsg = new FacesMessage(FacesMessage.SEVERITY_ERROR, Constants.ROLE_ALREADY_EXISTS, Constants.ROLE_ALREADY_EXISTS);
            FacesContext.getCurrentInstance().getExternalContext().getFlash().setKeepMessages(true);
            FacesContext.getCurrentInstance().addMessage(null, facesMsg);
         }
         else if (creationMessage.equalsIgnoreCase(Constants.ROLE_CREATION_EXCEPTION))
         {
            FacesMessage facesMsg = new FacesMessage(FacesMessage.SEVERITY_ERROR, Constants.ROLE_CREATION_EXCEPTION, Constants.ROLE_CREATION_EXCEPTION);
            FacesContext.getCurrentInstance().getExternalContext().getFlash().setKeepMessages(true);
            FacesContext.getCurrentInstance().addMessage(null, facesMsg);
         }
         else if (creationMessage.equalsIgnoreCase(Constants.FAILURE))
         {
            FacesMessage facesMsg = new FacesMessage(FacesMessage.SEVERITY_ERROR, Constants.ROLE_CREATION_FAILURE, Constants.ROLE_CREATION_FAILURE);
            FacesContext.getCurrentInstance().getExternalContext().getFlash().setKeepMessages(true);
            FacesContext.getCurrentInstance().addMessage(null, facesMsg);
         }
      }
   ...
   public String deleteRole()
   {
      ...
      if (deleteFlag)
      {
         FacesMessage facesMsg = new FacesMessage(FacesMessage.SEVERITY_INFO, Constants.ROLE_DELETION_SUCCESS, Constants.ROLE_DELETION_SUCCESS);
         FacesContext.getCurrentInstance().getExternalContext().getFlash().setKeepMessages(true);
         FacesContext.getCurrentInstance().addMessage(null, facesMsg);
      }
      return searchRole();
   ...
   /**
    * This method is for redirecting the view to the update view by loading the role details (non-Javadoc)
    * 
   ...
   /**
    * This method is for updating the details of the selected role (non-Javadoc)
    * 
   ...
   public String updateRole()
   {
      ...
      if (updateFlag)
      {
         FacesMessage facesMsg = new FacesMessage(FacesMessage.SEVERITY_INFO, Constants.ROLE_UPDATION_SUCCESS, Constants.ROLE_UPDATION_SUCCESS);
         FacesContext.getCurrentInstance().getExternalContext().getFlash().setKeepMessages(true);
         FacesContext.getCurrentInstance().addMessage(null, facesMsg);
      }
      return searchRole();
   ...
   /**
    * This method is for searching all the roles without any filter (non-Javadoc)
    * 
   ...
   /**
    * This method is for searching the roles based on the filter criteria recieved from the user. (non-Javadoc)
    * 
   ...
   public String searchRolesByCriteria()
   {
      ...
      if (role != null && (StringUtils.isNotEmpty(role.getRoleName()) || StringUtils.isNotEmpty(role.getRoleDesc())))
      {
