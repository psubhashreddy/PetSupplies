...
public class CategoryConverter implements Converter
{
   ...
   @Inject
   private transient Logger logger = Logger.getLogger(CategoryConverter.class.getName());
    ...
    */
   @Override
   public Object getAsObject(FacesContext context, UIComponent component, String valueSubmitted)
   {
      ...
      try
      {
         ...
         return categoryService.getCategoryByCategoryId(Integer.valueOf(valueSubmitted));
      }
      catch (NumberFormatException e)
      {
         logger.log(Level.SEVERE, "provided is Not a valid value", e);
         throw new ConverterException(new FacesMessage(String.format(" Is not a valid Category ID", valueSubmitted)), e);
      }
   }
   ...
   public String getAsString(FacesContext context, UIComponent component, Object value)
   {
      ...
      {
         throw new ConverterException(new FacesMessage(String.format(" Is not a valid Category", value)));
      }
   }
