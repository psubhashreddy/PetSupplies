...
/**
 * This class is the dao implementation class where all crud operations are
 * performed
 * 
 * @author speddyre
 * @date 3rd June 2015
...
public class ProductDAOImpl implements ProductDAO {
	...
	public Product getProductbyProductId(int productId) {
		...
		try {
			Query query = em
					.createNamedQuery("findProductsById", Product.class)
					.setParameter(Constants.PRODUCT_ID, productId);
	...
	public Product getProductbyProductCode(String productCode) {
		...
		try {
			Query query = em.createNamedQuery("findProductsByCode",
					Product.class).setParameter(Constants.PRODUCT_CODE, productCode);
			return (Product) query.getSingleResult();
		} catch (Exception e) {
			logger.log(Level.SEVERE, "Exception in Searching Product by Code",
					e);
			return null;
		}
	}
	...
	public Product getProductByProductName(String productName) {
		...
		try {
			Query query = em.createNamedQuery("findProductsByName",
					Product.class).setParameter(Constants.PRODUCT_NAME, productName);
			return (Product) query.getSingleResult();
		} catch (Exception e) {
			logger.log(Level.SEVERE, "Exception in Searching Product By Name",
					e);
			return null;
		}
	}
	...
	public List<Product> getProductByDescription(String productDescription) {
		...
		Query query = em.createNamedQuery("findProductsByDescription",
				Product.class).setParameter(Constants.PRODUCT_DESC, productDescription);
		return (List<Product>) query.getResultList();
	}
	...
	public List<Product> getProductByPrice(double productPrice) {
		...
		Query query = em.createNamedQuery("findProductsByPrice", Product.class)
				.setParameter(Constants.PRODUCT_PRICE, productPrice);
		return (List<Product>) query.getResultList();
	}
	...
	public List<Product> getProductByCategoryId(long categoryId) {
		...
		Query query = em.createNamedQuery("findProductsByCategoryId",
				Product.class).setParameter(Constants.CATEGORY_ID, categoryId);
		return (List<Product>) query.getResultList();
	}
	...
	public List<Product> getProductByOrderId(long orderId) {
		...
		Query query = em.createNamedQuery("findProductsByOrderId",
				Product.class).setParameter("productorderId", orderId);
		return (List<Product>) query.getResultList();
	}
	...
	public List<Product> searchProductsByCriteria(Product product) {
		...
		Query query = em
				.createNamedQuery("findProductsByCriteria", Product.class)
				.setParameter(Constants.PRODUCT_CODE, product.getProductCode())
