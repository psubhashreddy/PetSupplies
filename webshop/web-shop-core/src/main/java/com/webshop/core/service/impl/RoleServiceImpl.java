...
public class RoleServiceImpl implements RoleService
{
   ...
   /**
    * This method is for updating the role with the modified details (non-Javadoc)
    * 
   ...
   public List<Role> getRolesByCriteria(Role role)
   {
      ...
      try
      {
         ...
         if (StringUtils.isNotEmpty(role.getRoleName()) && StringUtils.isEmpty(role.getRoleDesc()))
         {
         ...
         else if (StringUtils.isEmpty(role.getRoleName()) && StringUtils.isNotEmpty(role.getRoleDesc()))
         {
   ...
   /**
    * This method is for getting the non-admin role id for the new user creation from the user module
    * 
    * @return int
    */
