...
public class UserServiceImpl implements UserService {
	...
	public String createUser(User user) {
		...
		if (userNameAlreadyExists(user).equalsIgnoreCase(
				Constants.USER_ALREADY_EXISTS)
				|| userPhoneAlreadyExists(user).equalsIgnoreCase(
						Constants.USER_ALREADY_EXISTS)
				|| userEmailAlreadyExists(user).equalsIgnoreCase(
						Constants.USER_ALREADY_EXISTS)) {
	...
	/**
	 * This method is a utility method for validating the user existence by user
	 * name.
	 * 
	 * @param user
	 * @return String
	...
	public String userNameAlreadyExists(User user) {
		logger.info("*** In userNameAlreadyExists in ServiceImpl ***"
				+ user.toString());
	...
	/**
	 * This method is a utility method for validating the user existence by
	 * phone
	 * 
	 * @param user
	 * @return String
	...
	public String userPhoneAlreadyExists(User user) {
		logger.info("*** In userPhoneAlreadyExists in ServiceImpl ***"
				+ user.toString());
	...
	public String userEmailAlreadyExists(User user) {
		logger.info("*** In userEmailAlreadyExists in ServiceImpl ***"
				+ user.toString());
	...
	public List<User> searchUsersByCriteria(User user) {
		...
		try {
			...
			} else if (StringUtils.isNotEmpty(user.getFirstName())
					&& StringUtils.isEmpty(user.getUserName())
					&& StringUtils.isEmpty(user.getEmail())
					&& StringUtils.isEmpty(user.getPhone())) {
