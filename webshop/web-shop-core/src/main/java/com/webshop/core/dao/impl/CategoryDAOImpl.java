...
public class CategoryDAOImpl implements CategoryDAO
{
   ...
   public Category getCategoryByCategoryId(int categoryId)
   {
      ...
      Query query = em.createNamedQuery("findCategoriesById", Category.class).setParameter(Constants.CATEGORY_ID, categoryId);
   ...
   public Category getCategoryByCategoryName(String categoryName)
   {
      ...
      try
      {
         Query query = em.createNamedQuery("findCategoriesByName", Category.class).setParameter(Constants.CATEGORY_NAME, categoryName);
         return (Category) query.getSingleResult();
      }
      catch (Exception e)
      {
   ...
   /**
    * This method is for searching categories by category description (non-Javadoc)
    * 
   ...
   public Category getCategoryByCategoryDescription(String categoryDescription)
   {
      ...
      try
      {
         Query query = em.createNamedQuery("findCategoriesByDescription", Category.class).setParameter(Constants.CATEGORY_DESC, categoryDescription);
         return (Category) query.getSingleResult();
      }
      catch (Exception e)
      {
   ...
   public List<Category> searchCategoriesByCriteria(Category category)
   {
      ...
      Query query = em.createNamedQuery("findCategoriesByCriteria", Category.class).setParameter(Constants.CATEGORY_NAME, category.getCategoryName())
