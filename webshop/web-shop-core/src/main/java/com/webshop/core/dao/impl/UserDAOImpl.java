...
public class UserDAOImpl implements UserDAO {
	...
	public User searchUserByUserId(int userId) {
		...
		try {
			Query query = em.createNamedQuery("findUsersByUserId", User.class)
					.setParameter(Constants.USER_ID, userId);
			return (User) query.getSingleResult();
		} catch (Exception e) {
			logger.log(Level.SEVERE,
					"Exception in Searching User By User Id", e);
			return null;
		}
	}
	...
	public User searchUsersByUserName(String userName) {
		...
		try {
			Query query = em
					.createNamedQuery("findUsersByUserName", User.class)
					.setParameter(Constants.USER_NAME, userName);
			return (User) query.getSingleResult();
		} catch (Exception e) {
			logger.log(Level.SEVERE,
					"Exception in Searching User By User Name", e);
			return null;
		}
	}
	...
	public List<User> searchUsersByFirstName(String firstName) {
		...
		try {
			Query query = em.createNamedQuery("findUsersByFirstName",
					User.class).setParameter(Constants.FIRST_NAME, firstName);
			return (List<User>) query.getResultList();
		} catch (Exception e) {
			logger.log(Level.SEVERE,
					"Exception in Searching User By First Name", e);
	...
	public List<User> searchUsersByLastName(String lastName) {
		...
		try {
			Query query = em
					.createNamedQuery("findUsersByLastName", User.class)
					.setParameter(Constants.LAST_NAME, lastName);
			return (List<User>) query.getResultList();
		} catch (Exception e) {
			logger.log(Level.SEVERE,
					"Exception in Searching User By Last Name", e);
			return new ArrayList<User>();
		}
	}
	...
	public User searchUsersByPhone(String phone) {
		...
		try {
			Query query = em.createNamedQuery("findUsersByPhone", User.class)
					.setParameter(Constants.USER_PHONE, phone);
			return (User) query.getSingleResult();
		} catch (Exception e) {
	...
	public User searchUsersByEmail(String email) {
		...
		try {
			Query query = em.createNamedQuery("findUsersByEmail", User.class)
					.setParameter(Constants.USER_MAIL, email);
			return (User) query.getSingleResult();
		} catch (Exception e) {
	...
	public List<User> searchUsersByCriteria(User user) {
		...
		Query query = em
				.createNamedQuery("findUsersBySearchCriteria", User.class)
				.setParameter(Constants.USER_NAME, user.getUserName())
				.setParameter(Constants.FIRST_NAME, user.getFirstName())
				.setParameter(Constants.USER_PHONE, user.getPhone())
				.setParameter(Constants.USER_MAIL, user.getEmail());
		return (List<User>) query.getResultList();
	}
}
